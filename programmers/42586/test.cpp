...
INSTANTIATE_TEST_SUITE_P(
    NAME, TestParameters,
    ::testing::Values(std::make_tuple(std::vector<int>{93, 30, 55}, std::vector<int>{1, 30, 5}, std::vector<int>{2, 1}),
                      std::make_tuple(std::vector<int>{95, 90, 99, 99, 80, 99}, std::vector<int>{1, 1, 1, 1, 1, 1},
